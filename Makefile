...
PACKAGE_URL = http://www.gnu.org/software/inetutils/
PACKAGE_VERSION = 2.0
PATH_SEPARATOR = :
PRAGMA_COLUMNS = 
...
ftpd_INSTALL_HOOK = 
ftpd_PROPS = 
gl_LIBOBJS =  asnprintf.o chdir-long.o fcntl.o free.o getopt.o getopt1.o ioctl.o mbrtowc.o obstack.o printf-args.o printf-parse.o readline.o readutmp.o regex.o vasnprintf.o
gl_LTLIBOBJS =  asnprintf.lo chdir-long.lo fcntl.lo free.lo getopt.lo getopt1.lo ioctl.lo mbrtowc.lo obstack.lo printf-args.lo printf-parse.lo readline.lo readutmp.lo regex.lo vasnprintf.lo
gltests_LIBOBJS = 
gltests_LTLIBOBJS = 
