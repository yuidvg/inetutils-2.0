...
pkglibexecdir = $(libexecdir)/inetutils
...
am__aclocal_m4_deps = $(top_srcdir)/m4/00gnulib.m4 \
	...
	$(top_srcdir)/m4/error.m4 $(top_srcdir)/m4/explicit_bzero.m4 \
	...
	$(top_srcdir)/m4/getusershell.m4 $(top_srcdir)/m4/glob.m4 \
	$(top_srcdir)/m4/glob_h.m4 $(top_srcdir)/m4/gnulib-common.m4 \
	...
	$(top_srcdir)/m4/regex.m4 $(top_srcdir)/m4/rewinddir.m4 \
	$(top_srcdir)/m4/save-cwd.m4 $(top_srcdir)/m4/select.m4 \
	$(top_srcdir)/m4/servent.m4 $(top_srcdir)/m4/setenv.m4 \
	$(top_srcdir)/m4/sethostname.m4 \
	...
	$(top_srcdir)/m4/strnlen.m4 $(top_srcdir)/m4/sys_ioctl_h.m4 \
	...
	$(top_srcdir)/m4/sysexits.m4 $(top_srcdir)/m4/tempname.m4 \
	...
	$(top_srcdir)/m4/xsize.m4 $(top_srcdir)/m4/xvasprintf.m4 \
	$(top_srcdir)/m4/zzgnulib.m4 $(top_srcdir)/am/check_macro.m4 \
	...
	$(top_srcdir)/am/result.m4 $(top_srcdir)/configure.ac
...
CONFIG_CLEAN_FILES = summary.sh confpaths.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/config.hin \
	$(srcdir)/confpaths.h.in $(srcdir)/summary.sh.in \
...
ACLOCAL = ${SHELL} /workspaces/inetutils-2.0/build-aux/missing aclocal-1.16
ALLOCA = 
ALLOCA_H = alloca.h
AMTAR = $${TAR-tar}
...
AR = ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /workspaces/inetutils-2.0/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /workspaces/inetutils-2.0/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /workspaces/inetutils-2.0/build-aux/missing automake-1.16
AWK = mawk
BITSIZEOF_PTRDIFF_T = 
...
HAVE__BOOL = 1
HAVE__EXIT = 1
HELP2MAN = ${SHELL} /workspaces/inetutils-2.0/build-aux/missing help2man
HOSTENT_LIB = 
INCAUTH = 
INCIDN = 
...
LTLIBREADLINE = 
LTLIBTHREAD = 
MAKEINFO = ${SHELL} /workspaces/inetutils-2.0/build-aux/missing makeinfo
MKDIR_P = /bin/mkdir -p
MKTEMP = /bin/mktemp
NCURSES_INCLUDE = 
NETINET_IN_H = 
...
YACC = yacc
YFLAGS = 
abs_builddir = /workspaces/inetutils-2.0
abs_srcdir = /workspaces/inetutils-2.0
abs_top_builddir = /workspaces/inetutils-2.0
abs_top_srcdir = /workspaces/inetutils-2.0
ac_ct_AR = ar
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
...
ftpd_INSTALL_HOOK = 
ftpd_PROPS = 
gl_LIBOBJS =  asnprintf.o chdir-long.o fcntl.o free.o getcwd.o getcwd-lgpl.o getopt.o getopt1.o ioctl.o mbrtowc.o obstack.o printf-args.o printf-parse.o readline.o readutmp.o regex.o vasnprintf.o
gl_LTLIBOBJS =  asnprintf.lo chdir-long.lo fcntl.lo free.lo getcwd.lo getcwd-lgpl.lo getopt.lo getopt1.lo ioctl.lo mbrtowc.lo obstack.lo printf-args.lo printf-parse.lo readline.lo readutmp.lo regex.lo vasnprintf.lo
gltests_LIBOBJS = 
gltests_LTLIBOBJS = 
gltests_WITNESS = IN_INETUTILS_GNULIB_TESTS
...
install_sh = ${SHELL} /workspaces/inetutils-2.0/build-aux/install-sh
...
summary.sh: $(top_builddir)/config.status $(srcdir)/summary.sh.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
confpaths.h: $(top_builddir)/config.status $(srcdir)/confpaths.h.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
